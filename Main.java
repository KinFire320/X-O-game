...
public class Main {
	...
	public static void ShowScores() {
		...
		TextDecoration.printColored("\t\t", TextDecoration.HIGHLIGHT_MS);
		TextDecoration.printlnColored(player2Name + " : " + player2Score,
	...
	public static void main(String[] args) throws InterruptedException {
		...
		finish: while (!stop) {
			...
			TextDecoration.printlnColored("\t\twho place three in row loses",
					TextDecoration.GRAY);
		...
		input.nextLine();
		// superMode gameSuper = new superMode(); // tester place
